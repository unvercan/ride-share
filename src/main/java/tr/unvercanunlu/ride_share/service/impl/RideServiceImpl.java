...
public class RideServiceImpl implements RideService {
  ...
  public RideRequestedDto requestRide(RequestRideDto request) {
    ...
    try {
      ...
      log.error("Failed to request ride. passengerId={}", request.passengerId(), ex);
      throw ex;
    }
  }
  ...
  public List<NearRequestedRideDto> findNearestRequestedRides(Location current) {
    ...
    return Collections.unmodifiableList(nearRequestedRides);
  }
  ...
  public RideAcceptedDto acceptRide(AcceptRideDto request) {
    ...
    try {
      ...
      log.error("Failed to accept ride. rideId={}, driverId={}", request.rideId(), request.driverId(), ex);
      throw ex;
    }
  }
  ...
  public DriverApprovedDto approveAssignedDriver(UUID rideId) {
    ...
    try {
      ...
      log.error("Failed to approve ride. rideId={}", rideId, ex);
      throw ex;
    }
  }
  ...
  public RideRequestedDto rejectAssignedDriver(UUID rideId) {
    ...
    try {
      ...
      log.error("Failed to disapprove ride. rideId={}", rideId, ex);
      throw ex;
    }
  }
  ...
  public PassengerPickupDto startTrip(UUID rideId) {
    ...
    try {
      ...
      log.error("Failed to pickup passenger. rideId={}", rideId, ex);
      throw ex;
    }
  }
  ...
  public RideCompletedDto completeTrip(UUID rideId) {
    ...
    try {
      ...
      log.error("Failed to complete ride. rideId={}", rideId, ex);
      throw ex;
    }
  }
  ...
  public RideCanceledDto cancelRide(UUID rideId) {
    ...
    try {
      ...
      log.error("Failed to cancel ride. rideId={}", rideId, ex);
      throw ex;
    }
  }
  ...
  public Ride getRide(UUID rideId) throws NotFoundException {
    ...
    try {
      ...
      log.error("Failed to get ride detail. rideId={}", rideId, ex);
      throw ex;
    }
  }
